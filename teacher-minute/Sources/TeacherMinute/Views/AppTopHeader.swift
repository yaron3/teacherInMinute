  ...
  var body: some View {
	HStack(spacing: 10) {
	  Circle()
		...
		.overlay {
		  PlatformIcon(systemName: avatarSystemImage, size: 18, weight: .semibold, color: .appPurple)
		}
	  ...
	  Button {
		...
		ZStack(alignment: .topTrailing) {
		  Circle()
			...
			.overlay {
			  PlatformIcon(systemName: "bell.fill", size: 15, weight: .semibold, color: .appPrimaryText)
			}
